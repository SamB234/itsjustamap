        ...
        >
          ...
          {activePopupData.direction !== 'Overview' && (
            <div className="mb-4">
              ...
              <input type="range" id="radius-slider" min="1" max="1000" step="10" value={selectedRadius} onChange={handleRadiusChange} className="w-full h-2 bg-gray-300 rounded-lg appearance-none cursor-pointer range-lg" />
            </div>
          )}
